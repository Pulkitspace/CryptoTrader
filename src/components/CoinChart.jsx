  ...
  return (
    <>
      {chartData.length === 0 ? (
        ...
        <div>
          <Line data={myData} options={{ elements: { point: { radius: 1 } } }} className="chart" />
          <div className="btn-group">
            <button className="btn" onClick={() => setDays(1)}>24 Hours</button>
            <button className="btn" onClick={() => setDays(30)}>1 Month</button>
